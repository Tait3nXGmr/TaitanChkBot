...
$botToken = "6886370123:AAGAZHufnHuOGn1BvnS4qZT6mt6z2R6Eyh0";
    ...
    'inline_keyboard' => [
        [
            ['text' => "❀⋟ 𝐃єνєℓσρєя ⋞❀", 'url' => "https://t.me/taitangamer"],
                   ['text' => '◑ 𝐏ℓαи ☣', 'url' => 't.me/taitangamerzz'],
            ],
            [
                ['text' => '✘ 𝐀∂∂ 𝐌є 𝐓ο 𝐘ουя 𝐆яουρ ✘', 'url' => 'https://t.me/Taitan_Chk_Bot?startgroup=true'],
        ],
    ]
]);
...
┣<u>𝗜𝗣 𝗖𝗛𝗘𝗖𝗞𝗘𝗥</u> » /ip\n┣𝗨𝘀𝗮𝗴𝗲 »/ip <code>1.1.1.1</code>

┣<u>𝗕𝗜𝗡 𝗖𝗛𝗘𝗖𝗞𝗘𝗥</u> » /bin\n┣𝗨𝘀𝗮𝗴𝗲 » <code>/bin 601120</code> 

┣<u>𝗖𝗖 𝗚𝗘𝗡𝗘𝗥𝗔𝗧𝗘 </u> » /gen\n┣𝗨𝘀𝗮𝗴𝗲 » <code>/gen 601120xxx|xx|xx|xxx</code>

┣<u>𝗖𝗥𝗘𝗗𝗜𝗧𝗦 𝗖𝗔𝗥𝗗 </u> » /credits \n┣𝗨𝘀𝗮𝗴𝗲 »<code> /credits Check </code>

┣<u>𝗙𝗔𝗞𝗘 𝗔𝗗𝗥𝗘𝗦𝗦</u> » /fake\n├𝗨𝘀𝗮𝗴𝗲 » <code>/fake us</code>

┣<u>𝗦𝗞 𝗖𝗛𝗘𝗖𝗞𝗘𝗥</u> » /sk\n┣𝗨𝘀𝗮𝗴𝗲 » <code>/sk sk_live_</code>
...
//=============PRICE===============//
if ($cdata2 == "price") {
    $priceText = "<b>\n" . str_repeat(' ', 20) . "『 𝗣𝗿𝗶𝗰𝗲 💸』" . str_repeat(' ', 20) . "\n╔═════════════════╗\n •├3 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 2$\n •├7 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 4$\n •├15 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 7$\n •├30 𝑫𝒂𝒚𝒔 𝑷𝒍𝒂𝒏 ⇢ 12$\n╚═════════════════╝\n •├Dev ➳ <code>@TaitanGamer</code>\n━━━━━━━━━━━━━━━━━━━</b>";

    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => '𝑯𝑶𝑴𝑬', 'callback_data' => 'back2'], ['text' => '𝑩𝑼𝒀', 'url' => 'https://t.me/TaitanGamer']]
        ]
    ]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝗚𝗿𝗼𝘂𝗽 ", 'url' => "https://t.me/TaitanXSupport"], ['text' => "𝗖𝗵𝗮𝗻𝗻𝗲𝗹", 'url' => "https://t.me/TaitanXCc"]],
        [['text' => "𝗕𝗔𝗖𝗞 ", 'callback_data' => 'back2']]
    ]
]);
